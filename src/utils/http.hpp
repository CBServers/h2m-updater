...
namespace utils::http
{
	...
	bool get_data_stream(const std::string& url, const headers& headers = {}, const std::function<void(size_t)>& callback = {}, const std::function<void(const char*, size_t)>& stream_callback = {}, uint32_t retries = 2);
